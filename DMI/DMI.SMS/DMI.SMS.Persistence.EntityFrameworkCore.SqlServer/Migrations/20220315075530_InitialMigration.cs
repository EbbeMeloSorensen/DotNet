        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    accessaddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    stationid_icao = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    referencetomaintenanceagreement = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    altstationid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    wmostationid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    regionid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    wigosid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    wmocountrycode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    last_edited_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
