        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbstractEnvironmentalMonitoringFacilityId = table.Column<Guid>(type: "uuid", nullable: false),
                    AbstractEnvironmentalMonitoringFacilityObjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    ObjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Superseded = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeoSpatialLocations_AbstractEnvironmentalMonitoringFaciliti~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateEstablished = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ObservingFacilities_AbstractEnvironmentalMonitoringFaciliti~",
                        column: x => x.Id,
                        principalTable: "AbstractEnvironmentalMonitoringFacilities",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coordinate1 = table.Column<double>(type: "double precision", nullable: false),
                    Coordinate2 = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeoSpatialLocations_AbstractEnvironmentalMonitoringFacility~",
